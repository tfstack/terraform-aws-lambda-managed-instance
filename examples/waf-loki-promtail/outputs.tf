...
output "obs_bootstrap_bucket" {
  description = "S3 bucket holding Grafana dashboards and Promtail sample JSONL copied at EC2 bootstrap"
  value       = aws_s3_bucket.obs_bootstrap.bucket
}
